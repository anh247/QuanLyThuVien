...
//xoa rôi
        ...
        public bool sua(DataGridView data)
        {
            ...
            return DocGia_DAO.Instance.Sua(docgia, madocgiacu);
        }
        public bool Them(DataGridView dgvDSTTdocgia, string madocgia,string hoten,string namsinh,string diachi,string ngaylapthe, string matkhau)
        {
            /*DataGridViewRow row = data.SelectedCells[0].OwningRow;
        ...
        public bool Sua(DataGridView dgvDSTTdocgia, string madocgia, string hoten, DateTime ngaysinh, string diachi, DateTime ngaylapthe, string matkhau)
        {
            ...
            return DocGia_DAO.Instance.Sua(docgia, madocgia);
        }
    }
}
